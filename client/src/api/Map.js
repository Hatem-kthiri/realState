...
export const getListingsRequest = async () =>
  await axios.get("http://localhost:5000/api/houses");
export const getHousesFeedRequest = async () =>
  await axios.get("http://localhost:5000/api/houses/feed");
export const getListingRequest = async (id) =>
  await axios.get(`http://localhost:5000/api/houses/${id}`);
...
export const createListingRequest = async (values) => {
  try {
    ...
    return await axios.post("http://localhost:5000/api/houses", form, {
      headers: {
...
export const getQueryResultsRequest = async (values) => {
  try {
    ...
    return await axios.post("http://localhost:5000/api/houses/query", form, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    });
